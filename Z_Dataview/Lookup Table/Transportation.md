...
movement:
    ...
    carpet of flying (6ft. x 8ftx): {name: "Carpet of Flying (6ft. x 8ft.)", base: 30, slow: 30, normal: 20, fast: 15}
...
for (let move of Object.entries(pg.movement)) { // Loop through all the objects
    // dv.paragraph(Object.keys(move));  // There is only keys of 0 and 1; 1 hold sthe actual names
