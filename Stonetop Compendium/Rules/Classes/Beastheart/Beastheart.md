---
file_basename: Beastheart
file_dpath: Classes
item_id: beastheart
item_name: Beastheart
type: class
image: Image - Beastheart.webp
quote:
recoveries:
skills:
arrays:
---
![[Image - Beastheart.webp]]
...
**Skills:** You gain the Animal Handling skill. Then choose any two skills from the exploration or intrigue skillg roups. (*Quick Build:* Animal Handling, Navigate, Track.)

###### Beastheart Advancement Table

| Level | Features                                                                                                                                                       | Abilities                 | Wild Nature<br/> Abilities |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | -------------------------- |
...
| 4th   | Characteristic Increase, Minion Improvement, Essence Salvage, Minion Chain, Perk, Skill Characteristic Increase, Rampage Improvement, Skill, Unleash the Beast | Signature, 3, 5, 7        | 5                          |
...
##### Companions
###### Basilisk
![[Image - Basilisk.webp|right]]
![[Stonetop Compendium/Rules/Classes/Beastheart/Beastheart Companions/Basilisk|Basilisk]]
###### Bear

![[Image - Bear.webp|left]]
![[Bear]]
###### Boar
![[Image - Boar.webp|right]]
![[Boar]]
###### Condor
![[Image - Condor.webp|left]]
![[Condor]]
###### Deinonychus
![[Image - Deinonychus.webp|right]]
![[Deinonychus]]
###### Drake
![[Image - Drake.webp|left]]
![[Drake]]
###### Elemental Spark
![[Image - Elemental Spark.webp|right]]
![[Elemental Spark]]
###### Gummy Ball
![[Image - Gummy Ball.webp|left]]
![[Gummy Ball]]
###### Hellhound
![[Image - Hellhound.webp|right]]
![[Hellhound]]
###### Lightbender
![[Image - Lightbender.webp|left]]
![[Stonetop Compendium/Rules/Classes/Beastheart/Beastheart Companions/Lightbender|Lightbender]]
###### Panther
![[Image - Panther.webp|right]]
![[Stonetop Compendium/Rules/Classes/Beastheart/Beastheart Companions/Panther|Panther]]

###### Spider
![[Image - Spider.webp|left]]
![[Spider]]

###### Sporeling
![[Image - Sporeling.webp|right]]
![[Sporeling]]
###### Wolf
![[Image - Wolf.webp|left]]
![[Wolf]]
...
**Companion Actions.** Your companion is your ally, but they take their turn as part of your turn. For the purpose of effects that end at the end of the companion's turn, or any other rules elements that depend on the start or end of creature's turn, the start and end of your turn is also the start and end of the companion's turn.
...
**Shared Skills.** Your companion has any skill you have, and vice versa. N o matter what skills they possess, your companion can't take any action their physiology wouldn't allow (for instance, a wolf can't pick locks).

**Shared Space.** you and your companion can move freely through and stop in each other's spaces.

**Shared Perks, Titles, and Complications.** If you gain a benefit or a drawback by earning a perk, a title, or a complication, your companion shares the benefit or drawback. your companion can only be affected by benefits or drawbacks that logically affect an animal: for instance, an animal can't craft and therefore can't benefit from the Handy perk. If you're not sure what your companion can do, ask your Director.
...
>Although you and your companion share your action economy, you are treated as separate creatures for effects that grant or remove main actions, maneuvers, and move actions. For instance, a talent's [[Applied Chronometrics]] ability grants an extra maneuver. If both you and your companion are targeted by the ability, you both gain extra maneuvers.
>
...
flavor: Better lookaway-this might not be pretty.
keywords:
  - Magic
  - Ranged
usage: Maneuver
...
effects:
  - name: Effect
    effect: >-
      ...
      **Spend 1-5 Ferocity:** Your partner gainst additional temporary 
      Stamina equal to their Might score for each ferocity spent this way.

      **Spend 5 Ferocity:** You restore your dead partner to life with 1
      Stamina, even if their body was destroyed. They gain no temporary
      Stamina if you use this ability this way.
```
...
Though you can't gain ferocity outside of combat, you can use your heroic abilities and effects that cost ferocity without spending it. Whenever you or your companion uses an ability outside of combat that has a variable or unlimited ferocity cost, the ability can be used as if you had spent an amount of ferocity equal to your Victories.
...
| Rampage         | Effect                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 8               | At the end of each fo your turns, your companion must use their Feral Strike ability as a free maneuver. You can't willingly decrease the power roll outcome to a lower tier. For each ally damaged this way, you gain 2 surges, which you can use on this strike.                                                                                                                                                                                               |
| 12              | Your companion has damage immunity equal to their Inutition score.                                                                                                                                                                                                                                                                                                                                                                                               |
...
You can use and gain the benefits of a kit. See the Kits chapter of Draw Steel: Heroes for more information.
...
Your companion doesn't need to wear their trinket around their neck: a condor might wear a necklace wrapped around a talon, and a gelatinous sphere might carry it suspended inside their body!
...
###### 3-Ferocity Ability
Choose one heroic ability from the following, each of which costs 3 ferocity to use. (*Quick Build*: Hungry Like the Wolf)
...
You and your companion's Might and Intuition scores increase to 3.
...
##### Born to Run
You and your companion gains a +2 bonus to speed.
...
##### Reflexes Perfected
You and your companion's free strikes deal extra damage equal to your Intuition score. Whenever an adjacent enemy moves to a space that isn't adjacent, you or your companion can make an opportunity attack, even if the enemy shifted, teleported, was force moved, or another feature that doesn't provoke opportunity attacks.
...
![[Banshee Howl]]
![[Stonetop Compendium/Rules/Classes/Beastheart/Abilities/9th-Level Abilities/Guardian/Relentless|Relentless]]
...
##### Characteristic Increase
You and your companion's Might and Intuition scores increase to 5.
...
Additionally, you can spend 1 ferox as a free maneuver to allow you and your companion to each take a main action on your turn, instead of a main action and maneuver. On that turn, the ferocity cost of your heroic abilities is reduced by 1.
